...
if (!file_exists("config.php")) {
    $error_msg = "Your configuration file does not exist. Please make a copy of the default configuration (config.default.php) and rename it to config.php. <a href='https://github.com/x3rt/image-server/tree/master#setup'>More info</a>";
    $error_no_cfg = true;
    include 'error.php';
    die();
}
