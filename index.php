            ...
            if (version_compare($current_version, $new_version, '<') && isset($config['enable_updater']) && $config['enable_updater']) {
                ?>
                    <div class="alert text-center alert-warning alert-dismissible fade show" role="alert">
                        ...
                        <a href="https://github.com/x3rt/image-server/releases/latest" type="button" class="btn btn-warning">Changelog</a>
                ...
                ?>
                    <div class="alert text-center alert-warning" role="alert">
                        ...
                        <p>
                            ...
                            Please check the <a href="https://github.com/x3rt/image-server#full-configuration">documentation</a> for more information about how to configure these settings.
                            You can also view an example of the latest configuration <a href="https://github.com/x3rt/image-server/config.default.php">here</a>.
                        </p>
                    </div><br>
                <?php
            }
